...
def main():
    CRC_path = r'C:\Users\NaNa\Desktop\Ete2023\IA_2\Projetcovid\Datasets\CRC/'
    CRC_dir:List[str] = os.listdir(CRC_path)
    output_path = 'crc_h_bit_glcm_.csv'
    # #process the image
    features = process_images(CRC_path, CRC_dir)
